...
fun AccountInitMain2.initHeadOut(const: Constants) {
    ...
    const.initMainRoomConstantContainer(arrayOf("W5N3", "W3N1", "W8N2", "W6N3", "W3N5", "W4N3", "W3N6", "W2N2","W1N1"))

    //Colonization E51N41
    const.getMainRoomConstant("W5N3").initSlaveRoomConstantContainer(arrayOf("W5N4", "W5N2")) //M0
    const.getMainRoomConstant("W3N1").initSlaveRoomConstantContainer(arrayOf("W4N1", "W3N2", "W2N1","W2N2","W1N1")) //M1
    ...
    const.getMainRoomConstant("W1N1").initSlaveRoomConstantContainer(arrayOf("W1N2")) //M8
...
fun AccountInitMain2.initBodyOut(const: Constants) {
    ...
    const.s(1,4).model = SlaveRoomType.Colonize
    const.m(8).creepUseUpgraderAndBuilderFromMainRoom = true
    const.s(1,4).pathToRoom = arrayOf("W3N1","W2N1","W2N0","W1N0","W1N1")

    const.m(7).useCash = false
    const.m(8).useCash = false
